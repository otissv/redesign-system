...
const { getNameOrValue, resolveFunctionDefinitionToReturnValue } = reactDocgen.utils;
...
function actualNameHandler(documentation, path) {
    ...
    else if (types.ArrowFunctionExpression.check(path.node) ||
...
module.exports = actualNameHandler;
