...
`;
const Logo = ({ showBg }) => {
    const { base, title, linkComponent: Link, themeConfig: { logo }, } = docz.useConfig();
    if (!Link)
        return null;
    return (React.createElement(Wrapper$4, { showBg: showBg },
        React.createElement(Link, { to: typeof base === 'string' ? base : '/' }, logo ? (React.createElement(LogoImg, { src: logo.src, width: logo.width, alt: title })) : (React.createElement(LogoText, null, title)))));
};
