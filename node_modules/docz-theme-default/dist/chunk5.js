...
const CodeMirror = props => {
    const { themeConfig } = docz.useConfig();
    ...
    const editorProps = Object.assign({}, props, { editorDidMount: (codemirror) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(ScrollbarStyles, null),
        React.createElement(Scrollbar, { option: scrollbarOpts, linesToScroll: linesToScroll },
