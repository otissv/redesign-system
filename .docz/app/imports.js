export const imports = {
  ...
  'src/Form/form.mdx': () =>
    import(
      /* webpackPrefetch: true, webpackChunkName: "src-form-form" */ 'src/Form/form.mdx'
    ),
  'src/GoolgeMaps/GoogleMaps.mdx': () =>
    import(
  ...
  'src/theme/color/colors.mdx': () =>
    import(
      /* webpackPrefetch: true, webpackChunkName: "src-theme-color-colors" */ 'src/theme/color/colors.mdx'
    ),
  ...
  'src/theme/font/font.mdx': () =>
    import(
      /* webpackPrefetch: true, webpackChunkName: "src-theme-font-font" */ 'src/theme/font/font.mdx'
    ),
  'src/theme/radius/radius.mdx': () =>
    import(
      /* webpackPrefetch: true, webpackChunkName: "src-theme-radius-radius" */ 'src/theme/radius/radius.mdx'
    ),
  'src/theme/unit/unit.mdx': () =>
    import(
