    ...
    './src/Table/table.mdx': function(e, t, n) {
      ...
      function S(e) {
        var t = e.children,
          ...
          f = p(''.concat(b, '_').concat(d.id, '_checked'), c),
          j = f.state,
          h = f.setItem,
          O = p(''.concat(b, '_').concat(d.id, '_expanded'), i),
          x = O.state,
          T = O.setItem
        Object(o.useEffect)(
          function() {
      ...
      var H = l.a.createContext({})
      function z() {
        return Object(o.useContext)(H)
      }
      function L(e) {
        var t = e.allSelected,
          n = void 0 !== t && t,
        ...
        return l.a.createElement(H.Provider, { value: i }, a)
      }
      'undefined' !== typeof H &&
        H &&
        H === Object(H) &&
      ...
      var F = l.a.memo(function(e) {
        var t = e.allSelected,
          ...
          s = e.loading,
          m = e.onAdd,
          p = e.onAllSelectedChange,
          f = e.onDeleteSelected,
          j = e.selected,
          h = e.tableName,
          O = Object(a.a)(e, [
            'allSelected',
        ...
        return l.a.createElement(
          ...
          l.a.createElement(
            L,
            { allSelected: t, data: i, onAllSelectedChange: p },
            x,
            l.a.createElement(
              V,
              Object.assign(
      ...
      var Oe = l.a.memo(function(e) {
        ...
        var Z = Object(o.useCallback)(function(e, t) {
          ...
          re = p(''.concat(T, '_allSelected'), H.length === Y.length),
          ie = re.state,
          be = re.setItem
        Object(o.useEffect)(
          function() {
            be(H.length === Y.length)
          },
          [Y, H]
        )
        ...
        return l.a.createElement(
          ...
          'table' === U
            ? l.a.createElement(
                f.b,
                Object.assign({ className: R, themed: [W], height: m }, M),
                l.a.createElement(
                  f.b,
                  {
                    as: 'table',
                  ...
                  c ? l.a.createElement(K, null, c) : null,
                  l.a.createElement(
                    F,
                    {
                      allSelected: ie,
          ...
          d = Object(o.useMemo)(
            function() {
              return 'function' === typeof t
                ? t(Object(s.a)({ data: i, prop: n }, c, { index: b }))
                : t
            },
            [t, i, b, n, c]
          )
...
//# sourceMappingURL=src-table-table.71eb7f195bb3940d11db.js.map
