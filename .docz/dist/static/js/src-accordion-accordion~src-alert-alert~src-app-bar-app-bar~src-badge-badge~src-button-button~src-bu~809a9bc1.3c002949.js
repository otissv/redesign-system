  ...
  [1],
  {
    './src/Base/Base.tsx': function(e, n, t) {
        ...
        return function(e) {
          return e.theme
            ? Object.keys(e.theme.shared).reduce(function(n, t) {
                return e[t] ? Object(i.a)({}, n, e.theme.shared[t](e[t])) : n
              }, {})
            : {}
        }
      }
      ...
      var g = o.a.memo(function(e) {
        var n = e.animate,
          ...
          E = Object(c.useRef)(d.b[s || 'div'](n)),
          A = Object(c.useRef)(Object(l.default)(E.current)(m(), j, p, a)),
          O = Object(c.useMemo)(
            function() {
              return A.current
            },
    ...
    './src/theme/theme.ts': function(e, n, t) {
      ...
      var a = t(
        ...
        i = t('./node_modules/lodash/fp/merge.js'),
        r = t.n(i)
      function c(e) {
        var n = e.animation,
          t = '0.5s',
      ...
      function j() {
        ...
        return Object(a.a)(
          {},
          E({ unit: c, style: 'margin' }),
          E({ unit: c, style: 'padding' }),
          {
            border: function(e) {
              return { border: n[e] }
            },
      ...
      function E(e) {
        var n,
          ...
          l = function(e) {
            return 'string' !== e && r(e) && e.match(/%|px|rem|em|auto/)
          }
        function s(e, n) {
          switch (!0) {
            case 'default' === e:
        ...
        var u =
          ((n = {}),
          Object(o.a)(n, i, function(e) {
            return s(e, i)
          }),
          Object(o.a)(n, ''.concat(i, 'Bottom'), function(e) {
            return s(e, ''.concat(i, 'Bottom'))
          }),
          Object(o.a)(n, ''.concat(i, 'Left'), function(e) {
            return s(e, ''.concat(i, 'Left'))
          }),
          Object(o.a)(n, ''.concat(i, 'Right'), function(e) {
            return s(e, ''.concat(i, 'Right'))
          }),
          Object(o.a)(n, ''.concat(i, 'Top'), function(e) {
            return s(e, ''.concat(i, 'Top'))
          }),
          n)
        return Object.keys(t).reduce(function(e, n) {
          if ('default' === n) return e
          var c = ''.concat(i).concat(d()(n))
          return Object(a.a)(
            {},
            e,
            Object(o.a)({}, c, function(e) {
              ...
              return Object.keys(c).reduce(function(e, r) {
                return Object(
                  a.a
                )({}, e, Object(o.a)({}, ''.concat(i, '-').concat(c[r]), t[n]))
              }, {})
            })
          )
        }, u)
      ...
      function A() {
        ...
        return Object(a.a)({}, r, { shared: j(r) })
      }
      'undefined' !== typeof x &&
        x &&
        x === Object(x) &&
...
//# sourceMappingURL=src-accordion-accordion~src-alert-alert~src-app-bar-app-bar~src-badge-badge~src-button-button~src-bu~809a9bc1.0fdaed2baef5ba4a9603.js.map
