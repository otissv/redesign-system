    ...
    './src/Checkbox/Checkbox.tsx': function(e, n, a) {
      ...
      function d(e) {
        ...
        return {
          ...
          height: i[5],
          width: i[5],
          border: t['thin'.concat(s()(n))] || t.thin,
          color: '#fff',
          cursor: 'pointer',
          ...
          'input:checked+.CheckboxBackground, input:indeterminate+.CheckboxBackground': {
            background: a ? 'none' : l({ appearance: n, color: c }),
            '.CheckboxCheckmark': { opacity: 1 },
          },
        }
      }
      'undefined' !== typeof d &&
...
//# sourceMappingURL=src-checkbox-checkbox.a207fa0f391889dcebe8.js.map
