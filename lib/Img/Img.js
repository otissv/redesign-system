...
exports.default = exports.img = exports.Img = void 0;
...
var ImgStyled = _styledComponents.default.img(_templateObject(), _img.imgTheme, _utils.sharedStyles, _img.imgSizeTheme, function (props) {
  return props.styled;
});

var ImgComponent = function ImgComponent(props) {
  return _react.default.createElement(ImgStyled, (0, _extends2.default)({}, props, {
    theme: props.theme
  }));
};
...
function (_Component) {
  ...
  function Img() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(Img).apply(this, arguments));
  }
  ...
  (0, _createClass2.default)(Img, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_ThemeContext.ThemeConsumer, null, function (theme) {
        return _react.default.createElement(ImgComponent, (0, _extends2.default)({}, _this.props, {
          responsive: null,
...
Img.propTypes = {
  ...
  themed: _propTypes.default.objects
};