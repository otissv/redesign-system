export function buttonTheme(_a) {
    var _b = _a.theme, animation = _b.animation, color = _b.color, border = _b.border, font = _b.font, unit = _b.unit;
    var activeState = {
...
export function buttonAppearanceTheme(_a) {
...
export function buttonSizeTheme(_a) {
    var size = _a.size, _b = _a.theme, font = _b.font, unit = _b.unit;
    switch (size) {
        case 1:
            return {
                padding: "0 " + unit[1],
...
export function buttonStretchTheme(_a) {
