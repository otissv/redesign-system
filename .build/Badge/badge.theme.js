export function badgeTheme(_a) {
    var _b = _a.theme, border = _b.border, color = _b.color;
    return {
...
export function badgeAppearanceTheme(_a) {
...
export function badgePillTheme(_a) {
    var pill = _a.pill;
    return pill
        ? {
            paddingRight: ' 0.6em',
...
//# sourceMappingURL=badge.theme.js.map