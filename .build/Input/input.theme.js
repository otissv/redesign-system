...
export function inputAppearanceTheme(_a) {
...
export function inputSizeTheme(_a) {
    var size = _a.size, font = _a.theme.font;
    switch (size) {
        case 1:
...
export function inputWidthsTheme(_a) {
...
//# sourceMappingURL=input.theme.js.map